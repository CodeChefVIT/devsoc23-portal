      ...
      try {
        ...
        const { data } = await axios.post<ServerResponse>(
          `${process.env.NEXT_PUBLIC_SERVER_URL}/users/signup`,
          {
            ...
            college: formik.values.collegename,
            collegeYear: "2021",
            ...
            <div className={styles.formcontainer}>
              <div className={styles.namescontainerform}>
                <div className="flex flex-col">
                  ...
                  ></input>
                  {formik.touched.firstname && formik.errors.firstname ? (
                    <div className="ml-32 mt-1 text-sm text-red-700">
                  ...
                  <input
                    ...
                    className={
                      formik.touched.lastname && formik.errors.lastname
                        ? styles.errorlastnameinput
                        : styles.lastnameinput
                    }
                  ></input>
                  {formik.touched.lastname && formik.errors.lastname ? (
                    <div className="ml-8 mt-1 text-sm text-red-700 xl:ml-0 xl:self-center">
              ...
              <div className={styles.personaldetailscontainer}>
                <div className="flex flex-col">
                  <label className={styles.collegenamelabel}>
                    College Name
                  </label>
                  <input
                    type="text"
                    ...
                    className={
                      formik.touched.collegename && formik.errors.collegename
                        ? styles.errorcollegenameinput
                        : styles.collegenameinput
                    }
                  ></input>
                  {formik.touched.collegename && formik.errors.collegename ? (
                    <div className="ml-32 mt-1 text-sm text-red-700">
